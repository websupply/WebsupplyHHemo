...
namespace WebsupplyHHemo.API.ADO
{
    ...
    {
        public static CadastroCondicaoPagtoResponseDto CADASTRO_UNIDADES_FILIAIS(string Connection, string CGCMatriz, UserModel userModel, CadastroCondicaoPagtoRequestDto requestDto)
        {
